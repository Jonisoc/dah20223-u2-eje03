...
export class UpdStudentPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.myForm.controls['curp'].disable();
    this.myForm.controls['age'].disable();
    this.myForm.controls['nip'].disable();
    this.myForm.controls['email'].disable();
    this.myForm.controls['photo'].disable();
    this.myForm.controls['career'].disable();
  }
  ...
  public updStudent(data):void{
    ...
    this.studentService.updateById(this.student.id, this.student);
    let indice = this.studentService.getIndexByCN(this.myForm.get('controlnumber').value);
